...
public class Register extends javax.swing.JPanel {
 ...
 private void initComponents() {                          
        ...
        branchField.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        branchField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select branch", "Branch 1", "Branch 2" }));
        ...
        jLabel1.setText("<html><p style='width:250px;'>Welcome to <b>LaundryEase</b>! We are delighted to have you here. Our mission is to provide an effortless laundry experience tailored to your busy lifestyle. Whether you're a student, a professional, or a family, we're here to make laundry easier, faster, and worry-free. Thank you for choosing <b>LaundryEase</b> — your comfort is our commitment.</p></html>");
